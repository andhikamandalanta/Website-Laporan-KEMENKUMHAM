...
def replace_word():
    replacements = {
        ...
        'triwulann': request.form['triwulann'],
        'tahunn': request.form['tahunn'],
        'outputt': request.form['outputt'],
        'triwulannn': request.form['triwulannn'],
        'tahunnn': request.form['tahunnn'],
        'outputtt': request.form['outputtt'],
